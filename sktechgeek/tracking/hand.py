...
class HandTracking():
    ...
    def get_gesture(lm_list):
        gesture = ''
        if len(lm_list) != 0:
            if lm_list[8][2] < lm_list[8 - 2][2] and lm_list[20][2] > lm_list[20 - 2][2] and lm_list[16][2] > \
                    lm_list[16 - 2][2] and lm_list[12][2] > lm_list[12 - 2][2]:
                gesture = 'index'
            elif lm_list[8][2] > lm_list[8 - 2][2] and lm_list[20][2] < lm_list[20 - 2][2] and lm_list[16][2] > \
                    lm_list[16 - 2][2] and lm_list[12][2] > lm_list[12 - 2][2]:
                gesture = 'pinky'
            elif lm_list[8][2] < lm_list[8 - 2][2] and lm_list[20][2] < lm_list[20 - 2][2] and lm_list[16][2] > \
                    lm_list[16 - 2][2] and lm_list[12][2] > lm_list[12 - 2][2]:
